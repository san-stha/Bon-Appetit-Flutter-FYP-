...
class DescFoodPage extends StatefulWidget {
  const DescFoodPage({Key? key}) : super(key: key);

  @override
  State<DescFoodPage> createState() => _DescFoodPageState();
}

class _DescFoodPageState extends State<DescFoodPage> {
  @override
            ...
            child: Column(
              children: [
                ...
                GridView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: dp.decPriceFoood.value.data.length,
                  itemBuilder: (BuildContext context, int index) {
                    var mydata = dp.decPriceFoood.value.data[index];
                    return InkWell(
                      onTap: () {
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ListTile(
                                  ...
                                  subtitle: BAPTText(
                                      text: "Rs. " + mydata.price!.toInt().toString()),
                                ),
                              )
