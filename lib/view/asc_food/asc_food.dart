...
class AscFoodPage extends StatefulWidget {
  const AscFoodPage({Key? key}) : super(key: key);

  @override
  State<AscFoodPage> createState() => _AscFoodPageState();
}

class _AscFoodPageState extends State<AscFoodPage> {
  @override
            ...
            child: Column(
              children: [
                ...
                GridView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: ap.ascPriceFoood.value.data.length,
                  itemBuilder: (BuildContext context, int index) {
                    var mydata = ap.ascPriceFoood.value.data[index];
                    return InkWell(
                      onTap: () {
